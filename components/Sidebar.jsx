        ...
        <nav>
            <div className={`${styles.sidebar}`} ref={sidebar}>
                ...
                <ul className={styles.nav_lists}>
                    ...
                    <li
                        className={
                            route.pathname.includes("/calendar") ? `${styles.navActive}` : ""
                        }
                    >
                        <Link href="/calendar">
                            <a>
                    ...
                    <li
                        className={route.pathname.includes("/request") ? `${styles.navActive}` : ""}
                    >
                        <Link href="/request">
                            <a>
                    ...
                    <li
                        className={
                            route.pathname.includes("/approval") ? `${styles.navActive}` : ""
                        }
                    >
                        <Link href="/approval">
                            <a>
                    ...
                    <li
                        className={
                            route.pathname.includes("/configuration") ? `${styles.navActive}` : ""
                        }
                    >
